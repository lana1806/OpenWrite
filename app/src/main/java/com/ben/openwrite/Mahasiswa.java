...
public class Mahasiswa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Mahasiswa.this, Inputdata.class);
    ...
    void RefreshList() {
        ...
        ListView01 = findViewById(R.id.list_view1);
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                AlertDialog.Builder builder = new
                        AlertDialog.Builder(Mahasiswa.this);
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            ...
                            case 2:
                                ...
                                db.execSQL("deletefrombiodatawherenama='" + selection + "'");
                                RefreshList();
                                break;
                        }
                    }
